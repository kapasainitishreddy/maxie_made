...
export default function TermsPage() {
  return (
    <LegalPageLayout title="Terms of Service" lastUpdated="January 1, 2026">
      <p>
        These Terms of Service ("Terms") govern your access to and use of PharmaIP Radar (the
      ...
      <h2>5. Patent Data Disclaimer</h2>
      <p className="text-yellow-500">
        <strong>IMPORTANT:</strong> PharmaIP Radar is a research and analysis tool. It does not
        provide legal advice. Patent infringement analysis, freedom-to-operate (FTO) assessments,
        and other patent-related outputs should be reviewed by qualified intellectual property
        attorneys before being used for business decisions.
      </p>
      ...
      <p>
        ...
        <a href="mailto:legal@pharmaip-radar.com">legal@pharmaip-radar.com</a>.
      </p>
    </LegalPageLayout>
  );
}
